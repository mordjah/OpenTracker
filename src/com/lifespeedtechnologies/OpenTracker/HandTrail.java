...
public class HandTrail {
	...
	protected ArrayList<Point> coords;     // the points that form the trail
	...
	public synchronized void addPoint ( Point3D realPt ) // add hand coordinate to the coords list
	{
		try {
	 ...
	 */ {
		...
		g2.
				fillOval( pt.x - CIRCLE_SIZE / 2, pt.y - CIRCLE_SIZE / 2,
	...
	private void drawTrail ( Graphics2D g2, ArrayList<Point> coords,
							 int numPoints ) // draw (x,y) Points list as a polyline (trail)
	{
